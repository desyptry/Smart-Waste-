...
<div class="max-w-3xl mx-auto bg-white rounded-[2rem] shadow-xl border border-gray-100 overflow-hidden">
    ...
    <div class="bg-[#2D333D] px-8 py-6 flex justify-between items-center">
        <div>
            <h1 class="text-xl font-black text-white tracking-wide uppercase">Ubah Jadwal Pengumpulan</h1>
            <p class="text-gray-400 text-xs font-medium mt-1">Perbarui slot jadwal operasional yang telah dibuat sebelumnya</p>
        </div>
    ...
    <div class="p-8 md:p-10">
        <form id="edit-schedule-form" action="{{ route('officer.jadwal.update', $schedule->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT') {{-- Mengarahkan Laravel agar membaca rute sebagai rute UPDATE/PUT --}}

            {{-- Bagian Drop-Off Point --}}
            <div class="space-y-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="datetime-local" name="start_date" 
                           value="{{ old('start_date', \Carbon\Carbon::parse($schedule->start_date)->format('Y-m-d\TH:i')) }}" required 
                ...
                <div class="space-y-2">
                    ...
                    <input type="datetime-local" name="finish_date" 
                           value="{{ old('finish_date', \Carbon\Carbon::parse($schedule->finish_date)->format('Y-m-d\TH:i')) }}" required 
...
<script type="module">
    $(document).ready(function() {
        ...
        $('#edit-schedule-form').on('submit', function() {
