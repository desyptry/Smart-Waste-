...
<div class="bg-white rounded shadow">
    ...
    <div class="bg-green-300 p-2 font-semibold flex justify-between items-center">
    ...
    <div class="p-4">
        ...
        {{-- FORM INPUT --}}
        <form action="#" method="POST" class="mb-6 bg-gray-50 p-4 border rounded">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
                <div>
                    <label class="block text-xs font-bold mb-1">Tanggal</label>
                    <input type="date" name="tanggal" class="border border-gray-400 p-2 w-full rounded">
                </div>
                <div>
                    <label class="block text-xs font-bold mb-1">Kategori Sampah</label>
                    <select name="kategori" class="border border-gray-400 p-2 w-full rounded">
                ...
                <div>
                    ...
                    <input type="number" name="harga" placeholder="Contoh: 3000" class="border border-gray-400 p-2 w-full rounded">
                </div>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full border text-sm border-collapse text-left">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="border p-2"><span class="bg-blue-100 text-blue-800 px-2 py-1 rounded text-xs">Plastik</span></td>
                    ...
                    <tr class="hover:bg-gray-100">
                        <td class="border p-2">2025-01-01</td>
                        <td class="border p-2"><span class="bg-orange-100 text-orange-800 px-2 py-1 rounded text-xs">Kertas</span></td>
                        <td class="border p-2">Rp 1.500</td>
                        <td class="border p-2 text-center">
                            <button class="bg-yellow-500 hover:bg-yellow-600 text-white px-3 py-1 rounded mr-1">Edit</button>
                            <button class="bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded">Hapus</button>
                        </td>
