...
<body class="bg-[#F4F9FC] min-h-screen flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-5xl bg-white rounded-[3rem] shadow-2xl overflow-hidden flex flex-col md:flex-row border border-gray-100">
        ...
        <!-- Sisi Kiri: Form Daftar (Field Disesuaikan: Nama, Email, Alamat, Password) -->
            ...
            <form id="register-form" action="#" method="POST" class="space-y-4">
                ...
                <div class="space-y-1">
                    ...
                    <textarea name="address" required rows="2" placeholder="Jl. Teratai No. 123..." 
                              class="input-custom w-full px-6 py-4 bg-[#F8FAFC] border-2 border-transparent rounded-2xl font-bold text-slate-700 outline-none transition-all duration-300 resize-none"></textarea>
                </div>
        ...
        <!-- Sisi Kanan: Visual Branding (Tetap Konsisten Dark) -->
        <div class="hidden md:flex w-1/2 bg-[#2D333D] items-center justify-center p-12 relative">
            ...
            <div class="relative z-10 text-center">
                <img src="images/logo.png" alt="Smart Waste Logo" class="w-64 mx-auto mb-8 transform hover:scale-105 transition-transform duration-500">
            </div>
        </div>
    </div>
    ...
    <script type='module'>
        $(document).ready(function() {
            // Animasi Warna Label saat Fokus
